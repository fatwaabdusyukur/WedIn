    ...
    <div className="bg-shade-100">
      <div className="flex flex-col justify-center sm:flex-row sm:justify-around p-5 gap-4">
        ...
        <div className="md:basis-[65%] lg:basis-[75%]">
          <h1 className="font-marcellus  text-2xl">All invitation templates</h1>
      ...
      <div className="mt-10 pb-5">
        <div className="p-10 mx-0 md:mx-20 lg:mx-32 bg-green-300 md:rounded-tr-[5000px] lg:rounded-tr-full">
